...
sommelier_agent = Agent(
    ...
    instruction=(
        ...
        "• Accept user preferences (type, sweetness, body, flavor_notes, region, min_price, max_price, currency) or a specific wine name.\n"
        "• Always call send_to_recommender with either structured preferences or {'wine_name': 'Name'}.\n"
        "Workflow:\n"
        "1️⃣ When given preferences:\n"
        "   - Pass type, sweetness, body, flavor_notes, region, min_price, max_price, and currency to send_to_recommender.\n"
